...
(function (L13_UI) {
    ...
    })(ANGLE = L13_UI.ANGLE || (L13_UI.ANGLE = {}));
    let JOB;
    (function (JOB) {
        JOB[JOB["IDLE"] = 0] = "IDLE";
        JOB[JOB["PATROL"] = 1] = "PATROL";
    })(JOB = L13_UI.JOB || (L13_UI.JOB = {}));
    class Enemy extends ƒ.Node {
        constructor(_name = "Enemy", _position) {
            ...
            let cmpStateMachine = new L13_UI.ComponentStateMachineEnemy();
        ...
        update() {
            this.getComponent(L13_UI.ComponentStateMachineEnemy).act();
        ...
        chooseTargetPosition() {
            let range = L13_UI.sizeWall * L13_UI.numWalls / 2 - 2;
        ...
        displayAnimation() {
            this.show.mtxLocal.showTo(ƒ.Vector3.TRANSFORMATION(L13_UI.avatar.mtxLocal.translation, this.mtxWorldInverse, true));
